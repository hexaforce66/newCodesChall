Claro, aquí tienes el código Java moderno y puro que realiza la misma función que el código COBOL proporcionado:
...
Este código Java utiliza la clase `Scanner` para leer la entrada del usuario y realiza la misma lógica de negocio que el código COBOL original. La principal diferencia es que en Java, no es necesario especificar el tamaño de los campos como se hace en COBOL, y se utilizan tipos de datos más modernos y seguros. Además, el código Java es más conciso y fácil de leer que el código COBOL.