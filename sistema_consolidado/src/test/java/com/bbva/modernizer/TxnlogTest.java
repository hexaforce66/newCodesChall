...
public class TxnlogTest {
    ...
    public void testBuildAuditLine_ValidPayment_ReturnsAuditLine() {
        ...
        String expectedAuditLine = "PAY-ID=PAY-001;CUSTOMER=CUST-001;ACCOUNT=ACCT-001;AMOUNT=100.00;RETURN=0000;RISK=0;MESSAGE=Payment approved";
        ...
        // Assert
        assertEquals(expectedAuditLine, auditLine);
    }
}