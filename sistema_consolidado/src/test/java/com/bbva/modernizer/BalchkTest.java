...
public class BalchkTest {
    ...
    public void testValidateBalance_AccountBlocked_ReturnsAccountError() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(100.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.BLOCKED, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
    ...
    public void testValidateBalance_AccountClosed_ReturnsAccountError() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(100.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.CLOSED, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
        ReturnArea expectedReturnArea = new ReturnArea(ReturnCode.ACCOUNT_ERROR, "Account is not open", 0);
    ...
    public void testValidateBalance_PaymentCurrencyDiffersFromAccountCurrency_ReturnsAccountError() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(100.00), "USD", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
    ...
    public void testValidateBalance_PaymentExceedsDailyLimit_ReturnsReviewRequired() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(600.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
    ...
    public void testValidateBalance_InsufficientFunds_ReturnsBalanceError() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(1200.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
    ...
    @Test
    public void testValidateBalance_BalanceValidationApproved_ReturnsApproved() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUS-001", "ACC-001", BigDecimal.valueOf(100.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACC-001", "CUS-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(500.00), "EUR");
