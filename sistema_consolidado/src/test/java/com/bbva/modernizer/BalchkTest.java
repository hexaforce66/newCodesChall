...
public class BalchkTest {
    ...
    public void testValidateBalance_AccountBlocked_ReturnsAccountError() {
        ...
        Account account = new Account("ACCT-001", "CUST-001", AccountStatus.BLOCKED, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(5000.00), "EUR");
    ...
    public void testValidateBalance_PaymentCurrencyDiffers_ReturnsAccountError() {
        ...
        Account account = new Account("ACCT-001", "CUST-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(5000.00), "EUR");
        ReturnArea returnArea = new ReturnArea(ReturnCode.APPROVED, "Balance validation approved", 0);
    ...
    public void testValidateBalance_PaymentExceedsDailyLimit_ReturnsReviewRequired() {
        // Arrange
        Payment payment = new Payment("PAY-001", "CUST-001", "ACCT-001", BigDecimal.valueOf(6000.00), "EUR", "CHANNEL-1", "DEST-001", "20230220");
        Account account = new Account("ACCT-001", "CUST-001", AccountStatus.OPEN, BigDecimal.valueOf(1000.00), BigDecimal.valueOf(5000.00), "EUR");
        ReturnArea returnArea = new ReturnArea(ReturnCode.APPROVED, "Balance validation approved", 0);
