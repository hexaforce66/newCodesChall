...
public class CustvalTest {
    ...
    @Test
    public void testValidateCustomer_CustomerIdMissing_ReturnsError() {
        // Arrange
        Payment payment = new Payment("", "ACC-001", BigDecimal.valueOf(100), "EUR", "CHANNEL-1", "DEST-1", "2022-01-01");
